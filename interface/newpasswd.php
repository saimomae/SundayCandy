...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            ...
            <a href="../login & logout/login.html" class="fs-s1 mx-3 py-3 yellow no-underline hover-underline">Login</a>
    ...
    <section class="p-10 md-py-10">
        <div class="w-100pc md-w-70pc mx-auto py-10">
            <h2 class="white fs-l2 md-fs-xl1 fw-900 lh-2">
                Reset Password<span class="border-b bc-yellow bw-4"></span></h2>
        </div>
    </section>
    ...
    <section class="p-10 md-p-l5">
            <div class="br-6 bg-yellow-lightest-10 p-5 md-p-l5 flex flex-wrap md-justify-between md-items-center">
                    <div class="w-100pc md-w-50pc md-items-center"> <!Username>
                      <div class="white fw-600 fs-m1">Username</div>
                        <div class="flex my-5 p-l1">
                            <input type="text" name="input_username"
                                class="input-lg flex-grow-1 bw-0 fw-200 bg-yellow-lightest-10 white ph-yellow-lightest focus-white opacity-80 fs-s1 py-5 br-r-0"
                                placeholder="Username">
                        </div>
                    </div>

                    <div class="w-100pc md-w-50pc md-items-center"> <!NEWPASS>
                      <div class="white fw-600 fs-m1">New Password</div>
                        <div class="flex my-5 p-l1">
                ...
                <button type="submit" value="submit" class="button-lg bg-yellow white fw-500 fs-s1 br-l-0">Submit</button>
        <?php
        $mysqli->close();
        ?>
            </div>
