...
<body class="bg-black muli">
    ...
    <section id="Libary" class="p-0 md-p-5">
          <div class="flex flex-wrap">
            <h1 class="white fs-l3 lh-5 md-fs-xl1 md-lh-1 fw-900 ">End <span class="border-b bc-indigo bw-4">This Week</span></h1>
              <div class="w-100pc md-w-33pc p-10">
            ...
            <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Your <span class="border-b bc-indigo bw-4">Collection</span></h1><hr style="width:50%;text-align:left;margin-left:0;visibility: hidden">
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                      <img class="w-100pc" src="assets/images/Inthemoodforlove_480x.progressive.jpg" alt="">
                      <p class="fw-600 white fs-m3 mt-3">
            ...
            <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Wish List</h1><hr style="width:100%;text-align:left;margin-left:0;visibility: hidden">
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
              ...
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                      <img class="w-100pc" src="assets/images/Howl’s Moving Castle.jpg" alt="">
                      <p class="fw-600 white fs-m3 mt-3">
              ...
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                      <img class="w-100pc" src="assets/images/Godfather.jpg" alt="">
                      <p class="fw-600 white fs-m3 mt-3">
                          The Godfather
                      </p>
                      <div class="indigo fs-s3 italic after-arrow-right my-4">See More</div>
              ...
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                      <img class="w-100pc" src="assets/images/Handmaiden.jpeg" alt="">
                      <p class="fw-600 white fs-m3 mt-3">
                          Handmaiden
                      </p>
                      <div class="indigo fs-s3 italic after-arrow-right my-4">See More</div>
              ...
              <div class="w-100pc md-w-33pc p-10">
                  <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                      <img class="w-100pc" src="assets/images/Parasite.jpg" alt="">
                      <p class="fw-600 white fs-m3 mt-3">
                          Parasite
                      </p>
                      <div class="indigo fs-s3 italic after-arrow-right my-4">See More</div>
    ...
    <section id="Account" class="p-10 md-py-10">
        <div class="w-100pc md-w-70pc mx-auto py-10">
            <h2 class="white fs-l2 md-fs-xl1 fw-900 lh-2">
                Good after noon, <span class="border-b bc-indigo bw-4"> Ravipa</span></h2>
        </div>
    </section>
