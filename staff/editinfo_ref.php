...
<!-- <input type=text name=id value=" . $row['m_id'] . " Disabled><br>
<input type=text name=title value=" . $row['title'] . "><br>
<input type=text name=time value=" . $row['time'] . "><br>
<input type=text name=price_rent value=" . $row['price_rent'] . "><br>
<input type=text name=price_buy value=" . $row['price_buy'] . "><br>
<input type=text name=g_id value=" . $row['g_id'] . "><br> -->
