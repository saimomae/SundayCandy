    ...
    <section class="p-10 md-p-l5">
        ...
        <div class="br-6 bg-indigo-lightest-10 p-5 md-p-l5 flex flex-wrap md-justify-between md-items-center">
          <div class="w-100pc md-w-50pc p-l1"> <!movieID>
              <div class="flex my-5">
                <?php echo "<input type="text" name ="m_id" value=" . $row['m_id'] . " Disabled
          ...
          <?php } ?>
            <button input type="submit" name="submit" class="button-lg bg-indigo indigo-lightest fw-300 fs-s3 br-l-0">Edit</button>
        </div>
      </section>
